...
COMMANDS commands[] = {
    ...
    /* nexti        */ {"nexti", (action_t)command_do_tgdbcommand, TGDB_NEXTI},
    ...
    /* stepi        */ {"stepi", (action_t)command_do_tgdbcommand, TGDB_STEPI},
...
int command_set_syntax_type(const char *value)
{
    ...
    else if (strcasecmp(value, "for") == 0)
        lang = TOKENIZER_LANGUAGE_FOR;
