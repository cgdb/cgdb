...
#line 8 "gdbmi_grammar.y" /* yacc.c:339  */
...
#line 101 "gdbmi_grammar.c" /* yacc.c:339  */
...
#line 5 "gdbmi_grammar.y" /* yacc.c:355  */
 struct gdbmi_pdata; 

#line 134 "gdbmi_grammar.c" /* yacc.c:355  */
...
union YYSTYPE
{
#line 53 "gdbmi_grammar.y" /* yacc.c:355  */
...
#line 204 "gdbmi_grammar.c" /* yacc.c:355  */
};
...
#line 230 "gdbmi_grammar.c" /* yacc.c:358  */
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, int yyrule, struct gdbmi_pdata *gdbmi_pdata)
{
...
do {                                    \
  if (yydebug)                          \
    yy_reduce_print (yyssp, yyvsp, Rule, gdbmi_pdata); \
} while (0)
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 96 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  gdbmi_pdata->tree = (yyvsp[0].u_output);
}
#line 1389 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 3:
#line 100 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  gdbmi_pdata->tree = append_gdbmi_output (gdbmi_pdata->tree, (yyvsp[0].u_output));
  gdbmi_pdata->parsed_one = 1;
}
#line 1398 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 4:
#line 105 "gdbmi_grammar.y" /* yacc.c:1646  */
    { 
...
#line 1413 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 5:
#line 116 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_oob_record) = NULL;
}
#line 1421 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 6:
#line 120 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_oob_record) = append_gdbmi_oob_record ((yyvsp[-2].u_oob_record), (yyvsp[-1].u_oob_record));
}
#line 1429 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 7:
#line 124 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_result_record) = NULL;
}
#line 1437 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 8:
#line 128 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_result_record) = (yyvsp[-1].u_result_record);
}
#line 1445 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 9:
#line 132 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_result_record) = create_gdbmi_result_record ();
  (yyval.u_result_record)->token = (yyvsp[-2].u_token);
  (yyval.u_result_record)->result_class = (enum gdbmi_result_class)(yyvsp[0].u_result_class);
  (yyval.u_result_record)->result = NULL;
}
#line 1456 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 10:
#line 139 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_result_record) = create_gdbmi_result_record ();
  (yyval.u_result_record)->token = (yyvsp[-4].u_token);
  (yyval.u_result_record)->result_class = (enum gdbmi_result_class)(yyvsp[-2].u_result_class);
  (yyval.u_result_record)->result = (yyvsp[0].u_result);
}
#line 1467 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 11:
#line 146 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
...
#line 1477 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 12:
#line 152 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_oob_record) = create_gdbmi_oob_record();
  (yyval.u_oob_record)->record = GDBMI_STREAM;
  (yyval.u_oob_record)->option.stream_record = (yyvsp[0].u_stream_record);
}
#line 1487 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 13:
#line 158 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_async_record) = create_gdbmi_async_record ();
  (yyval.u_async_record)->token = (yyvsp[-2].u_token);
  (yyval.u_async_record)->async_record = (enum gdbmi_async_record_choice)(yyvsp[-1].u_async_record_choice);
  (yyval.u_async_record)->async_class = (enum gdbmi_async_class)(yyvsp[0].u_async_class);
}
#line 1498 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 14:
#line 165 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_async_record) = create_gdbmi_async_record ();
  (yyval.u_async_record)->token = (yyvsp[-4].u_token);
  (yyval.u_async_record)->async_record = (enum gdbmi_async_record_choice)(yyvsp[-3].u_async_record_choice);
  (yyval.u_async_record)->async_class = (enum gdbmi_async_class)(yyvsp[-2].u_async_class);
  (yyval.u_async_record)->result = (yyvsp[0].u_result);
}
#line 1510 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 15:
#line 173 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_async_record_choice) = GDBMI_EXEC;
}
#line 1518 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 16:
#line 177 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_async_record_choice) = GDBMI_STATUS;
}
#line 1526 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 17:
#line 181 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_async_record_choice) = GDBMI_NOTIFY;	
}
#line 1534 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 18:
#line 185 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
...
#line 1553 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 19:
#line 200 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
...
#line 1564 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 20:
#line 207 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_result) = append_gdbmi_result (NULL, (yyvsp[0].u_result));	
}
#line 1572 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 21:
#line 211 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_result) = append_gdbmi_result ((yyvsp[-2].u_result), (yyvsp[0].u_result));
}
#line 1580 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 22:
#line 215 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_result) = create_gdbmi_result ();
  (yyval.u_result)->variable = (yyvsp[-2].u_variable);
  (yyval.u_result)->value = (yyvsp[0].u_value);
}
#line 1590 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 23:
#line 221 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_variable) = strdup (gdbmi_text);
}
#line 1598 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 24:
#line 225 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_value) = append_gdbmi_value (NULL, (yyvsp[0].u_value));	
}
#line 1606 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 25:
#line 229 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_value) = append_gdbmi_value ((yyvsp[-2].u_value), (yyvsp[0].u_value)); 
}
#line 1614 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 26:
#line 233 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_value) = create_gdbmi_value ();
  (yyval.u_value)->value_choice = GDBMI_CSTRING;
  (yyval.u_value)->option.cstring = strdup (gdbmi_text); 
}
#line 1624 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 27:
#line 239 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_value) = create_gdbmi_value ();
  (yyval.u_value)->value_choice = GDBMI_TUPLE;
  (yyval.u_value)->option.tuple = (yyvsp[0].u_tuple);
}
#line 1634 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 28:
#line 245 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_value) = create_gdbmi_value ();
  (yyval.u_value)->value_choice = GDBMI_LIST;
  (yyval.u_value)->option.list = (yyvsp[0].u_list);
}
#line 1644 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 29:
#line 251 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_tuple) = NULL;
}
#line 1652 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 30:
#line 255 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_tuple) = create_gdbmi_tuple ();
  (yyval.u_tuple)->result = (yyvsp[-1].u_result);
}
#line 1661 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 31:
#line 260 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_list) = NULL;
}
#line 1669 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 32:
#line 264 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_list) = create_gdbmi_list ();
  (yyval.u_list)->list_choice = GDBMI_VALUE;
  (yyval.u_list)->option.value = (yyvsp[-1].u_value);
}
#line 1679 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 33:
#line 270 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_list) = create_gdbmi_list ();
  (yyval.u_list)->list_choice = GDBMI_RESULT;
  (yyval.u_list)->option.result = (yyvsp[-1].u_result);
}
#line 1689 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 34:
#line 276 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_stream_record) = create_gdbmi_stream_record ();
  (yyval.u_stream_record)->stream_record = (enum gdbmi_stream_record_choice)(yyvsp[-1].u_stream_record_choice);
  (yyval.u_stream_record)->cstring = strdup ( gdbmi_text );
}
#line 1699 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 35:
#line 282 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_stream_record_choice) = GDBMI_CONSOLE;
}
#line 1707 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 36:
#line 286 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_stream_record_choice) = GDBMI_TARGET;
}
#line 1715 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 37:
#line 290 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_stream_record_choice) = GDBMI_LOG;
}
#line 1723 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 38:
#line 294 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_token) = -1;	
}
#line 1731 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 39:
#line 298 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_token) = (yyvsp[0].u_token);
}
#line 1739 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;

  case 40:
#line 302 "gdbmi_grammar.y" /* yacc.c:1646  */
    {
  (yyval.u_token) = atol (gdbmi_text);
}
#line 1747 "gdbmi_grammar.c" /* yacc.c:1646  */
    break;


#line 1751 "gdbmi_grammar.c" /* yacc.c:1646  */
      default: break;
    }
